    ...
    return(
        <div className="flex flex-col justify-center bg-white px-10 py-10 rounded-3xl h-4/6">
            <div className="flex flex-col">
                <h1 className="text-3xl xl:text-xl font-Lato text-center">Verificacion de cuenta</h1>
                <p className="text-lg xl:text-base text-center mt-4">Ingresa el correo electronico con el que tengas asociada la cuenta</p>
            </div>
